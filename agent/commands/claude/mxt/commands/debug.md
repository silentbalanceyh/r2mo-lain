---
description: "Debug R2MO issues: invokes superpowers systematic-debugging directly, falls back to manual only if the skill is absent. Archives a Bug Report (problem, diagnostics, solution) to .r2mo/bugs/<yyyy-MM-dd>/."
